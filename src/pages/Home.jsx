...
const Home = () => {
    ...
    return (
        <div className="bg-gray-100">
            {/* Hero Section */}
            <section className='max-w-7xl mx-auto flex flex-col items-center pt-14 mb-20 px-4'>
                <h1 className='text-4xl sm:text-5xl font-playfair font-extrabold text-center'>
                    Celebrate Pakistan's Diversity with PakPride
                </h1>
                <p className='text-lg sm:text-xl text-center my-4 px-4 sm:px-0'>
            ...
            <section className='bg-[#894838] py-20 flex flex-col text-white items-center'>
                <h2 className='text-xl sm:text-2xl md:px-0 px-12 font-playfair font-semibold text-center mb-4'>
                    "With faith, discipline, and selfless devotion to duty, <br />
                    there is nothing worthwhile that you cannot achieve."
                </h2>
                <div className='flex flex-col sm:flex-row items-center gap-6'>
                    <img src={quaid} alt="Quaid-e-Azam" className='md:w-10 w-32 h-auto' />
                    <div className='text-center sm:text-left'>
                        <h3 className='md:text-sm text-lg font-medium'>Quaid-e-Azam Muhammad Ali Jinnah</h3>
                        <p className='md:text-sm text-md font-light'>(Pakistan's founder)</p>
                    </div>
                </div>
            </section>
            ...
            <section className='relative py-20'>
                ...
                <div className='bg-[#1F2937] relative max-w-3xl mx-auto flex flex-col gap-8 items-center justify-center h-72 md:rounded-xl px-4'>
                    <img src={dual} alt="DualForce" className='h-auto' />
                    <p className='text-center text-white md:px-0 px-4'>
